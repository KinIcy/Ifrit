	     ...
	     <div class="container">
	        <div class="row">
	           <div class="col-md-5">
	              <!-- Logo -->
	              <div class="logo">
	                 <h1><a href="index.html">IFRIT</a></h1>
	              </div>
	           </div>
	           <div class="col-md-5">
	              <div class="row">
    ...
    <div class="page-content">
		  ...
		  <div class="col-md-2">
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <li><a href="stats.html"><i class="glyphicon glyphicon-bullhorn"></i> Tendencias</a></li>
                    <li><a href="tables.html"><i class="glyphicon glyphicon-eye-open"></i> Seguidores</a></li>
                    <li><a href="editors.html"><i class="glyphicon glyphicon-pencil"></i> Editar</a></li>
                    <li class="submenu">
                         <a href="#">
                            <i class="glyphicon glyphicon-user"></i> Cuenta
                            <span class="caret pull-right"></span>
                         </a>
                         <!-- Sub menu -->
                         <ul>
                            <li><a href="login.html">Principal</a></li>
                            <li><a href="signup.html">Incognito</a></li>
                        </ul>
                    </li>
                </ul>
             </div>
      ...
      <div class="col-md-6">
        ...
        <div class="content-box-large box-with-header">
		  			...
		  			<div class="row">
		  				<div class="col-md-12">
		  					<div class="content-box-header">
			  					<div class="panel-title">Anonimo123</div>

								<div class="panel-options">
									<a href="#" data-rel="Eliminar"><i class="glyphicon glyphicon-trash"></i></a>
									<a href="#" data-rel="Editar"><i class="glyphicon glyphicon-pencil"></i></a>
								</div>
				  			</div>
		  				</div>
		  			</div>
          ...
          <i class="glyphicon glyphicon-thumbs-up"></i>Me gusta
          </button>
          <button class="btn btn-default btn-xs">
          <i class="glyphicon glyphicon-thumbs-down"></i>No me gusta
          </button>
          <button class="btn btn-default btn-xs">
